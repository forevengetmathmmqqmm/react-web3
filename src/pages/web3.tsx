...
function WebThree () {
    ...
    const [contractApi, setContractApi] = useState<any>(null);
    ...
    function conntectFox(params: any) {
    ...
    function sendTransaction() {
        ...
        .then(function(receipt: any){
            web3.eth.getBalance("0x8Ce73B72Cc5d76Ac50D233c9193a54A8Ed1779e5").then((res: any) => {
                console.log(res);
